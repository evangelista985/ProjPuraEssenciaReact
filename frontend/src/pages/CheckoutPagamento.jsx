...
export default function CheckoutPagamento() {
  ...
  return (
    <>
    <div className="container" style={{ paddingTop: 'clamp(84px,12vw,100px)', paddingBottom: 40, paddingLeft: 'clamp(12px,4vw,20px)', paddingRight: 'clamp(12px,4vw,20px)', maxWidth: 900, margin: '0 auto' }}>
