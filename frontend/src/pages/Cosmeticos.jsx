...
export default function Cosmeticos() {
  ...
  useEffect(() => {
    async function buscarCosmeticos() {
      setLoading(true);
      try {
        const { data } = await api.get('/produtos', { params: { categoria_id: 4 } });
        setProdutos(data);
      } catch (e) {
        console.error(e);
      }
    ...
    <div style={st.page}>
      ...
      <section style={st.hero}>
        ...
        <div className="container" style={{...st.heroContainer, position: 'relative', zIndex: 1}}>
          <div style={st.heroContent}>
                        <h1 style={st.heroTitulo}>Cosméticos Naturais</h1>
            <p style={st.heroSub}>Cuide-se com a pureza da natureza</p>
            <p style={st.heroDesc}>
              Cosméticos desenvolvidos com ingredientes naturais e sustentáveis, respeitando sua pele e o planeta.
            </p>
      ...
      <div className="container" style={{ padding: '60px 20px' }}>
        <div style={st.sectionHeader}>
          <h2 style={st.listTitulo}>Nossa Coleção</h2>
        ...
        {loading ? (
          <div style={st.loadingWrap}>
            ...
            <p>Preparando sua beleza natural...</p>
          </div>
        ) : produtosFiltrados.length === 0 ? (
          <div style={st.vazioWrap}>
            <p>Não encontramos o cosmético que você busca.</p>
  ...
  return (
    <div style={st.card} onClick={onClick}>
      <div style={st.imgContainer}>
        <img
          src={produto.imagem || 'https://via.placeholder.com/400x400/f8f9fa/1C3A2A?text=Cosmético'}
          alt={produto.nome}
          style={st.img}
        />
...
const st = {
  ...
  hero: { 
    ...
    backgroundImage: 'url(/img/banner_cosmeticos_v2.jpg)',
  ...
  beneficiosSection: { padding: '50px 0', background: '#FFF', borderBottom: '1px solid #F0EFEA' },
